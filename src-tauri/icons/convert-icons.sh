...
# ExcaliApp Icon Conversion Script
# This script converts SVG icons to various formats needed for Tauri

echo "🎨 Converting ExcaliApp SVG icons to various formats..."
...
convert icon.svg -resize 128x128 icon-128@2x.png

# Square logo sizes
convert icon.svg -resize 30x30 Square30x30Logo.png
convert icon.svg -resize 44x44 Square44x44Logo.png
convert icon.svg -resize 71x71 Square71x71Logo.png
convert icon.svg -resize 89x89 Square89x89Logo.png
convert icon.svg -resize 107x107 Square107x107Logo.png
convert icon.svg -resize 142x142 Square142x142Logo.png
convert icon.svg -resize 150x150 Square150x150Logo.png
convert icon.svg -resize 284x284 Square284x284Logo.png
convert icon.svg -resize 310x310 Square310x310Logo.png

# Store logo
convert icon.svg -resize 150x150 StoreLogo.png
